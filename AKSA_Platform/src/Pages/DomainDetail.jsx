    ...
    <div className="flex items-center gap-1 mb-1 sm:mb-0">
      {tooltip ? (
        <Tooltip text={tooltip}>
          <span className="font-medium text-gray-700 underline decoration-dotted text-xs sm:text-sm">
            {title}
          </span>
        </Tooltip>
      ) : (
      ...
      {badge && (
        <span
          className={`ml-2 px-1 sm:px-2 py-0.5 rounded text-xs font-semibold ${badge.color} bg-opacity-10`}
        >
          {badge.text}
        </span>
      )}
...
const SectionCard = ({ title, icon: Icon, color, children }) => (
  <div className="bg-white p-4 sm:p-5 rounded-xl shadow transition-shadow duration-200 hover:shadow-lg">
    <div
      className={`flex items-center gap-2 mb-3 sm:mb-4 font-semibold text-base sm:text-lg ${color}`}
    >
        ...
        <div className="flex-1 flex flex-col h-screen overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto scrollbar-hide p-4 sm:p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-2 max-w-xl mb-4">
              {/* Select Domain */}
              <div
                className="flex-1 min-w-[180px] max-w-[260px] relative"
                ref={dropdownRef}
              >
                ...
                <button
                  ...
                  className="flex w-full items-center justify-between rounded-lg border border-gray-300 bg-white px-4 py-2 text-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-primary transition-all overflow-hidden"
                  style={{ maxWidth: 260 }}
                >
                ...
                {open && (
                  <ul className="absolute left-0 mt-1 min-w-[180px] max-w-[260px] w-full overflow-auto rounded border border-gray-300 bg-white shadow-lg z-20">
                    <li
                      key="no-domain"
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 p-6 mx-auto text-sm">
              ...
              >
                ...
                />
                {whois?.DNSSEC && (
                  <InfoRow title="DNSSEC" value={whois.DNSSEC} />
                )}
              ...
              >
                ...
                <InfoRow
                  title="Platform"
                  value={httpHeaders?.platform || "N/A"}
                />
                <InfoRow
                  title="Keep-Alive"
              ...
              >
                ...
                <InfoRow
                  title="Description"
                  value={socialTags?.description || "N/A"}
                />
                <InfoRow
                  title="Keywords"
                  value={socialTags?.keywords || "N/A"}
                />
                <InfoRow
                  title="Canonical URL"
          ...
          <div className="flex-1 overflow-y-auto scrollbar-hide p-3 sm:p-4 lg:p-6">
            ...
            <div className="flex flex-col items-center justify-center py-10 animate-fade-in text-center text-gray-600">
              ...
              <p className="text-sm font-medium">
                Fetching domain insights for {selected}...
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row h-screen overflow-hidden">
        ...
        <div className="flex-1 flex flex-col h-screen overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto scrollbar-hide p-4 sm:p-6">
            ...
            {/* Domain Selection Section (same as main view) */}
            <div className="space-y-4 sm:space-y-6 mb-6">
              <div className="flex flex-col sm:flex-row gap-2 max-w-xl mb-4">
                {/* Select Domain */}
                <div className="flex-1 min-w-[180px] max-w-[260px] relative">
