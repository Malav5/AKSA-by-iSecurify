    ...
    <input
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          ...
          <div>
            ...
            <div className="text-lg font-bold text-gray-900">1 <span className="text-primary underline cursor-pointer ml-2 text-sm" onClick={() => setShowDomainsInline(true)}>View my domains</span></div>
</div>
<div>
