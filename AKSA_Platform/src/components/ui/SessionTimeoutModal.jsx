        ...
        <div className="text-center">
          ...
          <div className="mb-4">
            ...
            <div className="text-3xl font-bold text-red-500 bg-red-50 px-4 py-2 rounded-lg border border-red-200">
              ...
              For security reasons, regular user sessions expire after 12 minutes of inactivity. Timer appears after 2 minutes of inactivity. Your session will automatically reset when you're active.
            </p>
