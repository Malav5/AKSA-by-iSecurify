  ...
  const photos = [
    {
      ...
      heroContent: {
        ...
        subtitle:
          "Advanced threat detection, real-time monitoring, and comprehensive vulnerability management in one powerful platform",
        stats: [
    ...
    },
    {
      ...
      heroContent: {
        ...
        subtitle:
          "Comprehensive network surveillance with AI-powered analytics to detect and respond to threats before they impact your business",
        stats: [
    ...
    },
    {
      ...
      heroContent: {
        ...
        subtitle:
          "Powerful dashboards and reporting tools that turn complex security data into actionable intelligence for your team",
        stats: [
      ...
      >
        {photos.map((photo) => (
          <div key={photo.id} className="w-full flex-shrink-0 relative h-full">
            ...
            {/* Custom Overlay */}
            <div className="absolute inset-0 bg-[#800080]/60 mix-blend-multiply" />
