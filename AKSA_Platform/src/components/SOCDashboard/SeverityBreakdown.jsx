  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-80">
        <div className="loader ease-linear rounded-full border-2 border-[#800080] animate-spin h-24 w-24"></div>
  ...
  return (
    <div className="bg-white rounded-3xl shadow p-8 mb-8 border border-gray-100">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        ...
        {total > 0 && (
          <div className="mt-4 md:mt-0 bg-secondary text-primary px-6 py-2 rounded-full text-base font-semibold flex items-center">
